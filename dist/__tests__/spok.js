...
spok_1.default.printSpec = false;
let equalCalls;
let deepEqualCalls;
const assert = {
...
tape_1.default('\nmultiple specifications all valid', (t) => {
    ...
    const specs = {
        ...
        one: spok_1.default.ge(1),
        two: 2,
        true: true,
        hello: 'hello',
        object: { foo: 'bar' },
        three: spok_1.default.range(2, 4),
        four: spok_1.default.lt(5),
        anArray: spok_1.default.array,
        anotherArray: [1, 2, 3],
        anObject: spok_1.default.ne(undefined),
    };
    spok_1.default(assert, object, specs);
...
if (typeof spok_1.default.startsWith !== 'function') {
    spok_1.default.startsWith = (s) => {
...
tape_1.default('\nnested specifications all valid', (t) => {
    ...
    spok_1.default(assert, res, {
        $topic: 'spok-nested-all-valid',
        file: spok_1.default.test(/read-one-file/),
        line: 39,
        column: 17,
        inferredName: '',
        name: 'onread',
        location: spok_1.default.startsWith('onread'),
        propertyPaths: [
            'open.resource.context.callback',
            'stat.resource.context.callback',
            'read.resource.context.callback',
        ...
        args: {
            ...
            '1': {
                type: 'Buffer',
                len: spok_1.default.gt(1000),
                included: spok_1.default.lt(20),
                val: { utf8: spok_1.default.string, hex: '636f6e73742074657374203d207265717569' },
            },
            proto: 'Object',
        },
    });
...
tape_1.default('\nnested specifications in array', (t) => {
    ...
    const specs = {
        ...
        objArray: [{ foo: spok_1.default.string }, { bar: 'foo' }],
        numberArray: [1, 2],
        stringArray: ['h', 'e'],
        numberStringArray: [spok_1.default.gtz, 2, spok_1.default.startsWith('h'), 'e'],
    };
    spok_1.default(assert, object, specs);
    t.deepEqual(equalCalls, [
